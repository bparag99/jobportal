...
public class AdminController {
	 ...
	 * 
	 * @param admin
	 * @return Response Entity of Object type Description : This method creates a
	 *         new entry for an admin.
	...
	public ResponseEntity<Object> adminSave(@Valid @RequestBody AdminDTO adminDto, BindingResult bindingResult) {
		...
		try {
			...
			return new ResponseEntity<>("Admin Details Saved Successfully", HttpStatus.ACCEPTED);
	 ...
	 * 
	 * @param id
	 * @return Response Entity of type Admin Description : This method finds Admin
	 *         by id
	 ...
	 * 
	 * @param userName
	 * @return Response Entity of type Admin Description: This method finds Admin by
	 *         userName
	 * @GetMapping: Annotation for mapping HTTP GET requests onto specific handler
	 *              methods.
	 * 
