...
public class JobController {
	 ...
	 * 
	 * @param job
	 * @return Response Entity of String type Description : This method closes the
	 *         job module.
	 ...
	 * 
	 * @param id
	 * @return Response Entity of Job type Description : This method finds a job by
	 *         id
	 ...
	 * 
	 * @param name
	 * @return Response Entity of Object type Description : This method finds a job
	 *         by Skill
	 * @GetMapping: Annotation for mapping HTTP GET requests onto specific handler
	 *              methods.
	 * 
	 ...
	 * 
	 * @param jobDto
	 * @return Response Entity of Object type Description : This method posts a new
	 *         job.
	 * @PostMapping: Annotation for mapping HTTP POST requests onto specific handler
	 *               methods.
	 * 
