		...
		<div class="col-2">
			<div class="nav flex-column nav-pills" id="v-pills-tab"
				...
				<form id="viewpostedjobs" action="/recruiter/viewpostedjobs" method="get">
					<a class="nav-link active" id="v-pills-viewpostedjobstab" data-toggle="pill"
				...
				<div class="tab-pane fade show active" id="v-pills-myapplications"
					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<c:forEach items="${postedJobList}" var="job">
								<tr>
									<td>${job.getJobId()}</td>
									...
									<c:choose>
										<c:when test="${job.isJobStatus()}">
											<td>Active</td>
											<td><form action="/recruiter/recruit/${job.getJobId()}"
													method="GET">
