...
<body>
	...
	<div class="row">
		...
		<div class="col-10">
			<form action="/recruiter/updatepassword" method="post">
           
            <div class="form-group">
                <label for="exampleInputPassword1">Current Password</label>
                <input type="password" class="form-control col-6"name="currentPassword" id="exampleInputPassword1" required>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">New Password</label>
                <input type="password" class="form-control col-6" name="nPassword" onChange="onChange()" id="nPassword" required>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1"> Confirm Password</label>
                <input type="password" class="form-control col-6" name="cPassword" onChange="onChange()" id="cPassword" required>
            </div>
